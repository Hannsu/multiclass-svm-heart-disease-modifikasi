...
x4=np.arange(2)
ax4.bar(x4-0.2,tr_c,0.35,label="Training (80%)",color=RED,alpha=0.85,edgecolor=RD)
ax4.bar(x4+0.2,te_c,0.35,label="Testing (20%)",color=GR,alpha=0.85,edgecolor="#2c3e50")
